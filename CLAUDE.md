...
- Real hostnames (*.cluster.local, *.cluster.local)
...
- **Dashboard**: http://monitor.cluster.local
- **BookStack Docs**: http://docs.cluster.local/books/services/page/citadel-monitor
